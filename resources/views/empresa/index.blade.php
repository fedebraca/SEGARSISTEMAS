...
@section('cont')
    <div class="viewCont" v-cloak>
        <h1 class="ui dividing header">Gestión de Empresas</h1>
            ...
            <div class="content">
                <div class="ui form editar">
                    <div class="field">
                        ...
                        <input type="text" name="rzon_soc" v-model="e.rzon_soc">
                    </div>
                </div>
            </div>
            <div class="actions">
        ...
        <div class="ui small modal agregar">
            ...
            <div class="content">
                <div class="ui form agregar">
                    <div class="field">
                        <label>Razón Social</label>
                        <input type="text" name="rzon_soc" v-model="d.rzon_soc">
                    </div>
                </div>
            </div>
            <div class="actions">
...
@section('script')
    <script>
        $(document).ready(function () {
            var urlAgregar = '{{ URL::to('empresa/agregar') }}';
            var urlEdit = '{{ URL::to('empresa/editar') }}';
            var urlElim = '{{ URL::to('empresa/eliminar') }}';
            var urlActivar = '{{ URL::to('empresa/activar') }}';
            var urlTabla = '{{ URL::to('empresa/tabla') }}';
