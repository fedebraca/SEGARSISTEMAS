...
@section('cont')
    <div class="viewCont" v-cloak>
        <h1 class="ui dividing header">Gestión de Equipos</h1>
...
@section('script')
    <script>
        $(document).ready(function () {
            var urlAgregar = '{{ URL::to('equipo/agregar') }}';
            var urlEdit = '{{ URL::to('equipo/editar') }}';
            var urlElim = '{{ URL::to('equipo/eliminar') }}';
            var urlActivar = '{{ URL::to('equipo/activar') }}';
            var urlTabla = '{{ URL::to('equipo/tabla') }}';
