...
@section('cont')
    <div class="viewCont" v-cloak>
        <h1 class="ui dividing header">Gestión de Lugares / Equipos</h1>
            ...
            <div class="content">
                <div class="ui form editar">
                    <div class="field">
                        ...
                        <input type="text" name="rzon_soc" v-model="e.desig">
                    </div>
                </div>
            </div>
            <div class="actions">
        ...
        <div class="ui small modal agregar">
            ...
            <div class="content">
                <div class="ui form agregar">
                    <div class="field">
                        <label>Razón Social</label>
                        <input type="text" name="rzon_soc" v-model="d.desig">
                    </div>
                </div>
            </div>
            <div class="actions">
...
@section('script')
    <script>
        $(document).ready(function () {
            var urlAgregar = '{{ URL::to('lugar/agregar') }}';
            var urlEdit = '{{ URL::to('lugar/editar') }}';
            var urlElim = '{{ URL::to('lugar/eliminar') }}';
            var urlActivar = '{{ URL::to('lugar/activar') }}';
            var urlTabla = '{{ URL::to('lugar/tabla') }}';
