...
@section('cont')
    <div class="viewCont" v-cloak>
        <h1 class="ui dividing header">Gestión de Tipo de Accidentes</h1>
...
@section('script')
    <script>
        $(document).ready(function () {
            var urlAgregar = '{{ URL::to('tipoaccidente/agregar') }}';
            var urlEdit = '{{ URL::to('tipoaccidente/editar') }}';
            var urlElim = '{{ URL::to('tipoaccidente/eliminar') }}';
            var urlActivar = '{{ URL::to('tipoaccidente/activar') }}';
            var urlTabla = '{{ URL::to('tipoaccidente/tabla') }}';
